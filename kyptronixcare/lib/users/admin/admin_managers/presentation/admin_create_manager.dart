...
class AdminCreateManager extends StatefulWidget {
  const AdminCreateManager({super.key});
...
class _AdminCreateManagerState extends State<AdminCreateManager> {
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
        body: BlocConsumer<AdminCrudManagerBloc, AdminCrudManagerState>(
          listener: (context, state) {
            ...
            /* --------------------------- User Loading State --------------------------- */
            if (state is AdminCrudManagerLoading) {
            ...
            /* --------------------------- User Success State --------------------------- */
            else if (state is AdminCrudManagerSuccess) {
            ...
            else if (state is AdminCrudManagerEmailAlreadyExists) {
              Navigator.pop(context);
              currentDialog = StylishDialog(
                context: context,
          ...
          listenWhen: (previous, current) {
            ...
            return current is AdminCrudManagerLoading ||
                current is AdminCrudManagerSuccess ||
                current is AdminCrudManagerEmailAlreadyExists ||
                current is AdminCrudManagerError;
    ...
    return ElevatedButton(
      onPressed: () {
        if (_formKey.currentState!.validate()) {
          ...
          if (_formKey.currentState!.validate()) {
            // Submit form
            context.read<AdminCrudManagerBloc>().add(
                  CreateUserManagerEvent(
